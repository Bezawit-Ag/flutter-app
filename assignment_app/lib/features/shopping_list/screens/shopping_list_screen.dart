...
class ShoppingListScreen extends StatelessWidget {
                ...
                child: ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    valueColor: const AlwaysStoppedAnimation<Color>(
                        Color(0xFFFF9800)), // Keep accent color or make white? Keeping orange accent for now.
                  ),
                ),
              ),
              Padding(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              ...items.map((item) => _buildItemCard(context, item, controller)),
                            ],
                          );
                        },
                      ),
  ...
  Widget _buildItemCard(BuildContext context, ShoppingItem item, ShoppingListController controller) {
    return Container(
      ...
      child: ListTile(
        ...
        leading: GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              shape: BoxShape.circle,
              color: item.isChecked ? const Color(0xFFFF9800) : Colors.transparent,
        ...
        title: Text(
          ...
          style: TextStyle(
            ...
            decoration: item.isChecked ? TextDecoration.none : null, // Removed strikethrough to match image style usually
          ),
        ),
        subtitle: Text(
          item.quantity,
  ...
  void _showAddDialog(BuildContext context) {
    ...
    final categories = ['Dairy', 'Meat', 'Fruits', 'Vegetables', 'Bakery', 'Pasta', 'Spices', 'Other'];
            ...
            TextButton(
              onPressed: () {
                if (nameController.text.isNotEmpty) {
                  Provider.of<ShoppingListController>(context, listen: false).addItem(
                    nameController.text,
